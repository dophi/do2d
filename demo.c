...
static GLfloat winWidth = 0.0f;
static GLfloat winHeight = 0.0f;
//确定多边形绕法的方向  
bool bWinding = true;  
...
void ChangeSize(GLint w, GLint h) {  
    ...
    glOrtho(-winWidth/2, winWidth/2, -winHeight/2, winHeight/2, -100.0f, 100.0f);  
...
void RenderScene(void) {  
    ...
    glVertex3f(0.0f, winHeight/2, 0.0f);  


    glColor3f(0.0f, 0.0f, 1.0f);  
    glVertex3f(winWidth/2, -winHeight/2, 0.0f);  
